...
class App extends Component {
  ...
  async componentWillMount() {
    // Load Web3
    let web3 = new Web3('https://mainnet.infura.io/v3/6233bfbeb39a4f468f38edf05e8e1727')
  ...
  render() {
    return (
      <div>
        ...
        <center><img src={require ("./logo1.png")}/></center>
          <div className="row">
            <main role="main" className="col-lg-12 d-flex text-center">
              <div className="content mr-auto ml-auto" style={{ width: '800px' }}>
                <h3>Ethereum Transaction Tracker</h3>
                <div className="row">
                  <div className="col-4">
